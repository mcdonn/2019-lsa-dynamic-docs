...
2. add the bibliography "caus-appl.bib" for these slides by adding a "bibliography: " to the YAML. (Don't forget to include the file path!) 
...
Make sure the identation is the same as above, and all bullet points are incremental.
